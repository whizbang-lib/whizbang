...
/// <summary>
/// Tests for Azure Service Bus transport handling of null Payload deserialization scenarios.
/// Reproduces and verifies fixes for NullReferenceException when messages have missing "p" field.
/// </summary>
[Category("Transport")]
[Category("NullHandling")]
public class AzureServiceBusTransportNullPayloadTests {
  ...
  private static bool _simulateTransportNullCheck(IMessageEnvelope envelope) {
    // This mirrors the fix in AzureServiceBusTransport.SubscribeAsync:
    // if (envelope.Payload is null) { ... DeadLetterMessageAsync ... }
