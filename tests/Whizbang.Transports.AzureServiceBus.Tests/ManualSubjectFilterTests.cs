...
public class ManualSubjectFilterTests(ServiceBusEmulatorFixtureSource fixtureSource) {
  ...
  ///
  /// Context: In a consumer application, nested class commands like `ChatConversationsContracts+CreateCommand`
  /// produce routing keys like `a consumer.contracts.chat.chatconversationscontracts+createcommand`.
  /// The subscription filter is `[Subject] LIKE 'a consumer.contracts.chat.%'`.
  ///
  ...
  public async Task SqlFilter_WithPlusInSubject_ShouldMatchLikePatternAsync() {
    ...
    var subjectWithPlus = "a consumer.contracts.chat.chatconversationscontracts+createcommand";
  ...
  public async Task SqlFilter_WithDotInSubject_ShouldMatchLikePatternAsync() {
    ...
    var subjectWithDots = "a consumer.contracts.chat.chatconversationscontracts.createcommand";
  ...
  public async Task SqlFilter_WithMultiplePlusInSubject_ShouldMatchLikePatternAsync() {
    ...
    var subjectWithMultiplePlus = "a consumer.contracts.chat.outer+inner+createcommand";
