...
""";
  ...
  public async Task Generator_WithUserBaseClass_AutoDiscoversPolymorphicTypesAsync() {
    // Arrange - BaseConsumerEvent-like pattern with multiple derived events
    const string source = """
using Whizbang.Core;
using System.Collections.Generic;
...
public class BaseConsumerEvent : IEvent {
  public string EventId { get; init; } = "";
}

public class SeedCreatedEvent : BaseConsumerEvent {
  public string SeedId { get; init; } = "";
}

public class SeedProcessedEvent : BaseConsumerEvent {
  public DateTime ProcessedAt { get; init; }
}

public class SeedCompletedEvent : BaseConsumerEvent {
  public int TotalRecords { get; init; }
}

// Handler returns List<BaseConsumerEvent>
public record ProcessSeedBatchCommand : ICommand {
  public List<BaseConsumerEvent> Events { get; init; } = new();
}
""";
    ...
    // Should generate polymorphic factory for BaseConsumerEvent
    await Assert.That(code).Contains("CreatePolymorphic_TestApp_BaseConsumerEvent");
