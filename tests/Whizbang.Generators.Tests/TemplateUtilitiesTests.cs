...
public class TemplateUtilitiesTests {
  ...
  private static readonly System.Reflection.Assembly GeneratorsAssembly = typeof(MessageRegistryGenerator).Assembly;
...
namespace Test;";
    ...
    // Act
    var result = TemplateUtilities.ReplaceHeaderRegion(GeneratorsAssembly, template);
