...
namespace TestNamespace {
  ...
  public class OrderStatus {
    // Nested perspective class - should be named "OrderStatus.Projection"
...
""";
    ...
    // Assert - Should use CLR format name "TestNamespace.OrderStatus+Projection" in switch case
    ...
    await Assert.That(registrySource).Contains("\"TestNamespace.OrderStatus+Projection\"");
