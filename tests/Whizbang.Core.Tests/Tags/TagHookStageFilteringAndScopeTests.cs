...
///
/// a consumer application registers tag hooks at PostAllPerspectivesAsync:
...
public class TagHookStageFilteringAndScopeTests {
  ...
  public async Task ProcessTagsAsync_HookRegisteredAtPostAllPerspectives_DoesNotFireAtAfterReceptorCompletionAsync() {
    // Arrange — simulate a consumer application pattern: hook registered at PostAllPerspectivesAsync
