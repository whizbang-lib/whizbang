...
public class WhizbangJsonContextTests {
  ...
  public async Task CreateCombinedOptions_DeserializesPostgresInfinityTimestamp_Async() {
    ...
    // the type info resolver's default converter. This mirrors the JDNext failure
    // path: type info comes from JDNext's source-gen context, but the DateTimeOffset
