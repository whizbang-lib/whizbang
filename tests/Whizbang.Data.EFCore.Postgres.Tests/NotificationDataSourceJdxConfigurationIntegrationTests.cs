...
///   — the single line of glue a consumer needs.</description></item>
...
/// </list>
///
/// <para>If this test ever regresses, a consumer will hit the same SCRAM failure in
...
public class NotificationDataSourceConsumerConfigurationIntegrationTests : EFCoreTestBase {
  ...
  public async Task Stamper_AcquiresLeader_UnderUseNpgsqlDataSourceConfigurationAsync() {
    // 1. Build the EF Core-owned data source — exactly like a consumer does.
