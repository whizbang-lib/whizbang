...
public class WorkCoordinatorPublisherWorkerIntegrationTests : EFCoreTestBase {
  ...
  public async Task WorkerProcessesOutboxMessages_EndToEndAsync() {
    ...
    var workBatch = await workCoordinator.ProcessWorkBatchAsync(new ProcessWorkBatchContext(
          instanceId,
          "TestService",
          "test-host",
          12345,
    ...
    // Mark as published
    await workCoordinator.ProcessWorkBatchAsync(new ProcessWorkBatchContext(
      instanceId,
      "TestService",
      "test-host",
      12345,
  ...
  public async Task ProcessWorkBatch_MultipleIterationsProcessAllWorkAsync() {
    ...
    var workBatch3 = await workCoordinator.ProcessWorkBatchAsync(new ProcessWorkBatchContext(
      instanceId,
      "TestService",
      "test-host",
      12345,
    ...
    var workBatch4 = await workCoordinator.ProcessWorkBatchAsync(new ProcessWorkBatchContext(
      instanceId,
      "TestService",
      "test-host",
      12345,
