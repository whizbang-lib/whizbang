...
/// <summary>
/// JDX-bug regression lock. Before this fix:
...
///     EF wiring (e.g., <c>"bffservice-db"</c>).
...
///   - JDX wired EF to <c>"bffservice-db"</c> (correct) and notifications to
...
public class SourceGenEmitsNotificationConnectionStringPostConfigureTests {
  ...
  public async Task GeneratedExtension_DoesNotOverrideExplicit_ConnectionStringKey_FromAppSettingsAsync() {
    ...
    // Whizbang:Database:ConnectionStringKey in appsettings still wins — JDX's
...
/// <summary>
/// Test fixture DbContext mirroring the JDX shape:
