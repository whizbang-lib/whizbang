...
/// <summary>
/// End-to-end regression for the JDX Azure SCRAM-SHA-256 incident.
///
...
public class DbContextNotificationConnectionStringFallbackIntegrationTests : EFCoreTestBase {
  ...
  /// <summary>
  /// JDX production failure mode: when the DbContext is configured with
  ...
  /// </summary>
  /// <summary>
  /// <c>UseNpgsql(NpgsqlDataSource)</c> is JDX's production configuration.
