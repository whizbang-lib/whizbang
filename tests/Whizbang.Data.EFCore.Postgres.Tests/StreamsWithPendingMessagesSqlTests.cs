...
/// <summary>
/// <see cref="EFCoreWorkCoordinator{TDbContext}.GetStreamsWithPendingMessagesAsync"/>: which of the
...
/// </summary>
[Category("Shard1")]
[NotInParallel(nameof(StreamsWithPendingMessagesSqlTests))]
public class StreamsWithPendingMessagesSqlTests : EFCoreTestBase {
