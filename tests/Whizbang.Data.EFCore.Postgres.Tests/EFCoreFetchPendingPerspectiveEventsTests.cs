...
public class EFCoreFetchPendingPerspectiveEventsTests : EFCoreTestBase {
  ...
  /// <summary>
  /// Slot-3 G6: when wh_event_store has a stamped commit_sequence, the C# reader's
  ...
  /// <summary>
  /// Slot-3 G6: same coverage for the atomic claim-and-fetch variant. Locks the non-null
