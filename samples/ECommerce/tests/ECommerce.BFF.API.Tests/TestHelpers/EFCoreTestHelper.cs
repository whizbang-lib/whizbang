...
public sealed class EFCoreTestHelper : IAsyncDisposable {
  ...
  public EFCoreTestHelper() {
    ...
    services.AddScoped<ECommerce.BFF.API.Perspectives.ShippingPerspective>();
    services.AddScoped<ECommerce.BFF.API.Perspectives.ProductCatalogPerspective>();
    services.AddScoped<ECommerce.BFF.API.Perspectives.PaymentPerspective>();
    services.AddScoped<ECommerce.BFF.API.Perspectives.InventoryPerspective>();
    services.AddScoped<ECommerce.BFF.API.Perspectives.PaymentFailedPerspective>();
    services.AddScoped<ECommerce.BFF.API.Perspectives.OrderPerspective>();
