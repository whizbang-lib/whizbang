...
// Register perspectives (ProductCatalogPerspective, InventoryLevelsPerspective)
// Generated by PerspectiveRunnerRegistryGenerator - registers all IPerspectiveRunner implementations
_ = builder.Services.AddPerspectiveRunners();

// TODO: BFF.API doesn't have receptors, so ReceptorDiscoveryGenerator doesn't run
// Need to refactor SeedMutations to use IOutbox/ITransport instead of IDispatcher
...
// TODO: SeedMutations requires IDispatcher which isn't available in BFF (no receptors)
// Need to refactor to use IOutbox/ITransport
...
builder.Services
  ...
  // .AddMutationType<SeedMutations>()  // TODO: Disabled until SeedMutations refactored
...
// TODO: Disabled until SeedMutations refactored to not use IDispatcher
// #if DEBUG
