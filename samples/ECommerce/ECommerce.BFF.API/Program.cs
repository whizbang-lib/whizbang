...
consumerOptions.Subscriptions.Add(new TopicSubscription("payments", "bff-service"));
consumerOptions.Subscriptions.Add(new TopicSubscription("shipping", "bff-service"));
