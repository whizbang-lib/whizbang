...
This guide explains how to use the new MessageTagProcessor pipeline in a consumer application to automatically process tagged messages after receptor completion.
