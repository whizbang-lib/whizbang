...
/// MessageId order on fan-in streams. The result was 5,622 cursor inversions per JDX
/// bulk-import run, mostly on BulkJobImportOrchestration / UberDraftJob / saga streams.
/// </para>
/// <para>
