...
/// <tests>tests/Whizbang.Core.Tests/Messaging/IScopedEventStoreQueryTests.cs</tests>
public interface IScopedEventStoreQuery {
  ...
  /// <tests>tests/Whizbang.Core.Tests/Messaging/IScopedEventStoreQueryTests.cs:IScopedEventStoreQuery_HasQueryAsyncMethodAsync</tests>
  ...
  /// <tests>tests/Whizbang.Core.Tests/Messaging/IScopedEventStoreQueryTests.cs:IScopedEventStoreQuery_HasExecuteAsyncMethodAsync</tests>
...
public sealed class EventStoreQueryScope(IServiceScope scope, IEventStoreQuery eventStoreQuery) : IDisposable {
  ...
  /// </summary>
  /// <tests>tests/Whizbang.Core.Tests/Messaging/IScopedEventStoreQueryTests.cs:EventStoreQueryScope_HasDisposeMethodAsync</tests>
  public void Dispose() {
    _scope.Dispose();
  }
}
