...
/// </summary>
[JsonConverter(typeof(OutboxMessageDataConverter))]
...
/// <summary>
/// Custom JSON converter for OutboxMessageData that accepts both short and long property names.
...
/// </summary>
internal sealed class OutboxMessageDataConverter : JsonConverter<OutboxMessageData> {
  public override OutboxMessageData? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) {
  ...
  public override void Write(Utf8JsonWriter writer, OutboxMessageData value, JsonSerializerOptions options) {
