...
public class PolicyContext {
  ...
  /// </summary>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:Constructor_InitializesWithMessage_SetsMessageAndMessageTypeAsync</tests>
  ...
  /// </summary>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:Constructor_WithEnvelope_SetsEnvelopeAsync</tests>
  ...
  /// </summary>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:Constructor_WithServiceProvider_SetsServicesAsync</tests>
  public IServiceProvider? Services { get; private set; }

  /// <summary>
  /// The environment name (e.g., "development", "staging", "production").
  /// </summary>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:Constructor_WithEnvironment_SetsEnvironmentAsync</tests>
  public string Environment { get; private set; }

  /// <summary>
  /// When this context was created (approximately when message processing started).
  /// </summary>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:Constructor_SetsExecutionTime_ToApproximatelyNowAsync</tests>
  ...
  /// </summary>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:Constructor_InitializesTrail_CreatesEmptyDecisionTrailAsync</tests>
  ...
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:GetService_ReturnsService_WhenServiceProviderSetAsync</tests>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:GetService_ThrowsException_WhenServiceProviderNotSetAsync</tests>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:GetService_ThrowsException_WhenServiceNotRegisteredAsync</tests>
  ...
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:GetMetadata_ReturnsValue_WhenKeyExistsAsync</tests>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:GetMetadata_ReturnsNull_WhenKeyDoesNotExistAsync</tests>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:GetMetadata_ReturnsNull_WhenEnvelopeNotSetAsync</tests>
  ...
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:HasTag_ReturnsTrue_WhenTagExistsInMetadataAsync</tests>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:HasTag_ReturnsFalse_WhenTagDoesNotExistAsync</tests>
  ...
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:HasFlag_ReturnsTrue_WhenFlagIsSetAsync</tests>
  ...
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:MatchesAggregate_ReturnsTrue_WhenMessageIsForSpecifiedAggregateTypeAsync</tests>
  /// <tests>tests/Whizbang.Policies.Tests/PolicyContextTests.cs:MatchesAggregate_ReturnsFalse_WhenMessageIsForDifferentAggregateTypeAsync</tests>
