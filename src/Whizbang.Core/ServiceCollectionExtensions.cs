...
public static class ServiceCollectionExtensions {
  ...
  public static WhizbangBuilder AddWhizbang(this IServiceCollection services) {
    ...
    // Uses IAggregateIdExtractor if registered (by generated AddWhizbangAggregateIdExtractor)
    services.TryAddSingleton<IStreamIdExtractor>(sp => {
      var aggregateIdExtractor = sp.GetService<IAggregateIdExtractor>();
      return new StreamIdExtractor(aggregateIdExtractor);
    });
