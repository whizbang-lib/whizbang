...
--              with a stream_id, then per-row NOT EXISTS against wh_event_store. production
--              2026-06-11 PM measured the unindexed scan at 137 ms mean (~11 % of production
