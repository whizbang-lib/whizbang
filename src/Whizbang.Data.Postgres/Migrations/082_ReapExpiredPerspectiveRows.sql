-- Migration: 082_ReapExpiredPerspectiveRows.sql
-- Date: 2026-07-17
-- Description: E2-4d d-4 — physically reap logically-expired TransientStorage.TtlRow perspective rows.
--              Re-creates perform_maintenance VERBATIM from 081 plus a new Task 9 that dynamically enumerates
--              every wh_per_* table having an expires_at column and DELETEs rows past their expiry. The lens
--              filter (d-3) already hides these from reads; this frees the storage. debug_mode-skipped.
-- Dependencies: 081 (perform_maintenance), 080 (body_meta expiry), d-1 (perspective expires_at column)
