-- Migration: 018_AddPerspectiveWorkToProcessWorkBatch.sql
-- Description: Updates process_work_batch to return perspective checkpoint work
-- Dependencies: 016_AddActiveStreamsTable.sql (wh_active_streams exists)
--              012_CreateAcquirePerspectiveCheckpointFunction.sql (wh_perspective_checkpoints exists)

-- Drop and recreate function with perspective work support
...
BEGIN
  IF v_debug_mode THEN
    RAISE NOTICE '==== MIGRATION VERSION: 2025-12-18_ADD_PERSPECTIVE_WORK ===';
