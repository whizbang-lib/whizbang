...
DECLARE
  ...
  -- stream generated one dead tuple per stream per tick in production (a consumer dev
  -- production: 1.8B lifetime updates on 5,790 rows) and dominated WAL pressure.
