...
public sealed class SagaGenerator : IIncrementalGenerator {
  ...
  private const string ATTRIBUTE_SOURCE = """
    ...
    namespace Whizbang.Sagas {
      ...
      public sealed class SagaAttribute : global::System.Attribute {
      ...
      [global::System.AttributeUsage(global::System.AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
      public sealed class SagaAttribute<TEventBase> : global::System.Attribute where TEventBase : class, global::Whizbang.Core.IEvent {
        public SagaAttribute(string sagaName) { SagaName = sagaName; }
        public string SagaName { get; }
        public bool IncludeHooks { get; set; } = true;
        public bool GenerateService { get; set; } = true;
  ...
  public void Initialize(IncrementalGeneratorInitializationContext context) {
    context.RegisterPostInitializationOutput(ctx =>
      ctx.AddSource("SagaAttribute.g.cs", SourceText.From(ATTRIBUTE_SOURCE, Encoding.UTF8)));
