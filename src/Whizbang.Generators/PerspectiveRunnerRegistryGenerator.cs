...
#pragma warning restore S3267
  ...
  /// </summary>
  private static void _appendFileHeader(StringBuilder source, string namespaceName) {
    source.AppendLine("// <auto-generated/>");
    source.AppendLine($"// Generated by {nameof(PerspectiveRunnerRegistryGenerator)} at {Whizbang.Generators.Shared.Utilities.TemplateUtilities.DeterministicBuildStamp}");
