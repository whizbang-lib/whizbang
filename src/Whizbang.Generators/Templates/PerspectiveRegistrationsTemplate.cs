...
public static class PerspectiveRegistrationExtensions {
  ...
  public static WhizbangPerspectiveBuilder AddWhizbangPerspectives(this IServiceCollection services) {
    ...
    // rewind-vs-live race window that produced JDX's 4-lost-increment bulk-import
  ...
  /// <remarks>
  /// This method provides strongly-typed access to perspective Apply methods via delegates.
  /// All type matching and delegate creation happens at compile time for AOT compatibility.
  /// Example:
  /// <code>
  /// var associations = GetPerspectiveAssociations&lt;OrderModel, OrderCreatedEvent&gt;("MyService");
  /// foreach (var assoc in associations) {
  ///   var updatedModel = assoc.ApplyDelegate(currentModel, @event);
  /// }
  /// </code>
  /// </remarks>
  ...
  public static System.Collections.Generic.IReadOnlyList<PerspectiveAssociationInfo<TModel, TEvent>> GetPerspectiveAssociations<TModel, TEvent>(string serviceName)
    ...
    // This region gets replaced with generated typed association array
    #endregion
  }
}
