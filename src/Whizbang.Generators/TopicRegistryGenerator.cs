...
public class TopicRegistryGenerator : IIncrementalGenerator {
  ...
  private static void _generateTopicRegistry(
    ...
    source.AppendLine($"// Generated by TopicRegistryGenerator ({Whizbang.Generators.Shared.Utilities.TemplateUtilities.GetDeterministicBuildStamp(typeof(TopicRegistryGenerator).Assembly)})");
