...
/// <summary>
/// PostgreSQL upsert strategy using EF Core change tracking.
/// Uses query-then-save pattern for now. Future optimization: native ON CONFLICT when EF Core adds support.
